...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        auto_attr = ('id', 'created_at', 'updated_at', '__class__')
        class_name = ''
        name_ptn = r'(?P<name>(?:[a-zA-Z]|_)(?:[a-zA-Z]|\d|_)*)'
        class_match = re.match(name_ptn, args)
        obj_kwargs = {}
        if class_match is not None:
            ...
            for param in params:
                param_match = re.fullmatch(param_ptn, param)
    ...
    def do_all(self, args):
        """ Shows all objects, or all objects of a class eg all State (Note: State = Args)"""
        print_list = []
